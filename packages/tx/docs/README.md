...
_Defined in [types.ts:19](https://github.com/ethereumjs/ethereumjs-vm/blob/7d27b6f/packages/tx/src/types.ts#L19)_
...
_Defined in [types.ts:14](https://github.com/ethereumjs/ethereumjs-vm/blob/7d27b6f/packages/tx/src/types.ts#L14)_
